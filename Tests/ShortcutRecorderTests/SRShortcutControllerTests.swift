...
class SRShortcutControllerTests: XCTestCase {
    ...
    func testNoSelectionMarker() {
        ...
        XCTAssertTrue((c.value(forKeyPath: ShortcutControllerKeyPath.keyEquivalent.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertTrue((c.value(forKeyPath: ShortcutControllerKeyPath.keyEquivalentModifierMask.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertTrue((c.value(forKeyPath: ShortcutControllerKeyPath.literalKeyCode.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertTrue((c.value(forKeyPath: ShortcutControllerKeyPath.symbolicKeyCode.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertTrue((c.value(forKeyPath: ShortcutControllerKeyPath.literalASCIIKeyCode.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertTrue((c.value(forKeyPath: ShortcutControllerKeyPath.symbolicASCIIKeyCode.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertTrue((c.value(forKeyPath: ShortcutControllerKeyPath.literalModifierFlags.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertTrue((c.value(forKeyPath: ShortcutControllerKeyPath.symbolicModifierFlags.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))

        c.content = Shortcut.default
        XCTAssertFalse((c.value(forKeyPath: ShortcutControllerKeyPath.keyEquivalent.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertFalse((c.value(forKeyPath: ShortcutControllerKeyPath.keyEquivalentModifierMask.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertFalse((c.value(forKeyPath: ShortcutControllerKeyPath.literalKeyCode.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertFalse((c.value(forKeyPath: ShortcutControllerKeyPath.symbolicKeyCode.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertFalse((c.value(forKeyPath: ShortcutControllerKeyPath.literalASCIIKeyCode.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertFalse((c.value(forKeyPath: ShortcutControllerKeyPath.symbolicASCIIKeyCode.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertFalse((c.value(forKeyPath: ShortcutControllerKeyPath.literalModifierFlags.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
        XCTAssertFalse((c.value(forKeyPath: ShortcutControllerKeyPath.symbolicModifierFlags.rawValue) as! NSObject).isEqual(NSBindingSelectionMarker.noSelection))
